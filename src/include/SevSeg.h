...
//  void NewNumber(int number_in, byte DecPlace_in);
  void Begin(boolean mode_in, byte numOfDigits, byte digit1, byte digit2, byte digit3, byte digit4, byte digit5, byte digit6, byte digit7, byte digit8, byte segment1, byte segment2, byte segment3, byte segment4, byte segment5, byte segment6, byte segment7, byte segmentDP, boolean _powermode = true);
  void Begin(boolean mode_in, byte numOfDigits, byte digit1, byte digit2, byte digit3, byte digit4, byte digit5, byte digit6, byte digit7, byte digit8, byte digitColon, byte digitApostrophe, byte segment1, byte segment2, byte segment3, byte segment4, byte segment5, byte segment6, byte segment7, byte segmentDP, byte segmentColon, byte segmentApostrophe);
  void SetBrightness(byte percentBright);
  void display(String str, int deci = 0);
  void displayVar(int var, int deci = 0);
...
private:
  ...
  //Private Variables
  boolean mode, DigitOn, DigitOff, SegOn, SegOff, powermode;
